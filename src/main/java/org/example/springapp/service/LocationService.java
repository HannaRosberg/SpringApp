...
import org.example.springapp.dto.LocationDTO;
import org.example.springapp.entity.Location;

import org.example.springapp.repository.LocationRepository;
...
public class LocationService {
    ...
    public void softDeleteLocation(Integer id) {
        ...
        Location location = locationRepository.findByIdAndUserId(id, currentUsername)
                .orElseThrow(() -> new IllegalArgumentException("Can't find location with id " + id + " for user " + currentUsername));
